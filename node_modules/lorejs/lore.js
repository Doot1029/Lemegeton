...
(function (global, factory) {
  ...
  class Game {
    ...
    initBrowser() {
      ...
      this.terminalElement = document.querySelector(".lore-terminal");
    ...
    startGame(startRoomId) {
      ...
      // Call onEnter for the starting room if it exists
      const currentRoom = this.world.rooms.get(startRoomId);
      if (currentRoom && currentRoom.onEnter) {
        currentRoom.onEnter(this.state, this);
      }
    ...
    checkEvents() {
      this.world.events.forEach(event => {
        if (event.condition && event.condition(this.state, this)) {
          if (event.trigger) {
